...
$pwFile = "x:\windows\system32\config\caen\pw"
$aesKeyFile = "x:\windows\system32\config\caen\key"
$aesKey = get-content $aesKeyFile
$user = "umroot\caenadaccess"
$credential = New-Object -TypeName System.Management.Automation.PSCredential -ArgumentList $user, (Get-Content $pwFile | ConvertTo-SecureString -key $aesKey)
